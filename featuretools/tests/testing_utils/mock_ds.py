...
def make_nip_entityset(entityset_type=EntitySet):
    incidents_df = pd.DataFrame(index=[''],
                                data={'id': np.full(1, np.nan, dtype=long), 'test1': np.full(1, "", dtype=str),
                                      'test2': np.full(1, "", dtype=str), 'servicetac': np.full(1, np.nan, dtype=int),
                                      'operstatus': np.full(1, "", dtype=str), 'manager': np.full(1, "", dtype=str),
                                      'itseverity': np.full(1, "", dtype=str), 'appsupport': np.full(1, "", dtype=str),
                                      'numsymptoms': np.full(1, np.nan, dtype=int),
                                      'alertgroup': np.full(1, "", dtype=str), 'flash': np.full(1, np.nan, dtype=int),
                                      'iturgency': np.full(1, np.nan, dtype=int),
                                      'chtrapplication': np.full(1, "", dtype=str),
                                      'shortdescript': np.full(1, "", dtype=str), 'location': np.full(1, "", dtype=str),
                                      'cllicode': np.full(1, "", dtype=str), 'remedyflag': np.full(1, "", dtype=str),
                                      'suppresssend': np.full(1, "", dtype=str),
                                      's1severity': np.full(1, "", dtype=str),
                                      'impactpolicy': np.full(1, "", dtype=str), 'division': np.full(1, "", dtype=str),
                                      'serviceregion': np.full(1, np.nan, dtype=int),
                                      'resolvedtime': np.full(1, "", dtype="datetime64[ns]"),
                                      'postalcode': np.full(1, "", dtype=str),
                                      'ticketcreatetime': np.full(1, "", dtype="datetime64[ns]"),
                                      'itgroup': np.full(1, "", dtype=str), 'summary': np.full(1, "", dtype=str),
                                      'nodealias': np.full(1, "", dtype=str), 'ticketstatus': np.full(1, "", dtype=str),
                                      'causetype': np.full(1, np.nan, dtype=int),
                                      'identifier': np.full(1, "", dtype=str), 'custcity': np.full(1, "", dtype=str),
                                      'status': np.full(1, "", dtype=str), 'devicedescript': np.full(1, "", dtype=str),
                                      'servername': np.full(1, "", dtype=str), 'custstate': np.full(1, "", dtype=str),
                                      'customertype': np.full(1, "", dtype=str),
                                      'originalsummary': np.full(1, "", dtype=str),
                                      'comments': np.full(1, "", dtype=str), 'custzip': np.full(1, "", dtype=str),
                                      'servicekma': np.full(1, np.nan, dtype=int),
                                      'custstreet': np.full(1, "", dtype=str), 'url2': np.full(1, "", dtype=str),
                                      'suppressescl': np.full(1, np.nan, dtype=int),
                                      'custstreetname': np.full(1, "", dtype=str),
                                      'interface': np.full(1, "", dtype=str), 'alarmsource': np.full(1, "", dtype=str),
                                      'elementname': np.full(1, "", dtype=str), 'remedynum': np.full(1, "", dtype=str),
                                      'circuit': np.full(1, "", dtype=str), 'servicescope': np.full(1, "", dtype=str),
                                      'itoperatingsystem': np.full(1, "", dtype=str),
                                      'originalseverity': np.full(1, np.nan, dtype=int),
                                      'nmosserial': np.full(1, "", dtype=str), 'chtrtype': np.full(1, "", dtype=str),
                                      'grade': np.full(1, "", dtype=str),
                                      'deletedtime': np.full(1, "", dtype="datetime64[ns]"),
                                      'itvendor': np.full(1, "", dtype=str), 'itapplication': np.full(1, "", dtype=str),
                                      'poll': np.full(1, np.nan, dtype=int),
                                      'impactflag': np.full(1, np.nan, dtype=int), 'lob': np.full(1, "", dtype=str),
                                      'hfcfibernode': np.full(1, "", dtype=str),
                                      'firstoccurrence': np.full(1, "", dtype="datetime64[ns]"),
                                      'type': np.full(1, np.nan, dtype=int),
                                      'suppresssstart': np.full(1, "", dtype=str), 'eventid': np.full(1, "", dtype=str),
                                      's1mgddevice': np.full(1, "", dtype=str), 'tally': np.full(1, "", dtype=str),
                                      'alertkey': np.full(1, "", dtype=str), 'processid': np.full(1, "", dtype=str),
                                      'resolvestatus': np.full(1, np.nan, dtype=int),
                                      'sys_period': np.full(1, "", dtype=str),
                                      'nocviewtime': np.full(1, "", dtype="datetime64[ns]"),
                                      'resolved': np.full(1, np.nan, dtype=int),
                                      'tacviewtime': np.full(1, "", dtype="datetime64[ns]"),
                                      'agent': np.full(1, "", dtype=str),
                                      'deletedat': np.full(1, "", dtype="datetime64[ns]"),
                                      'serial': np.full(1, np.nan, dtype=long), 'severity': np.full(1, "", dtype=str),
                                      'causetype2': np.full(1, np.nan, dtype=int),
                                      'chtrcategory': np.full(1, "", dtype=str),
                                      'commstring': np.full(1, "", dtype=str), 'node': np.full(1, "", dtype=str),
                                      'acknowledgedtime': np.full(1, "", dtype="datetime64[ns]"),
                                      'lastmodified': np.full(1, "", dtype="datetime64[ns]"),
                                      'bundle': np.full(1, "", dtype=str), 'automation': np.full(1, "", dtype=str),
                                      'serverserial': np.full(1, np.nan, dtype=long),
                                      'class': np.full(1, np.nan, dtype=long),
                                      'lastoccurrence': np.full(1, "", dtype="datetime64[ns]"),
                                      'datatype': np.full(1, np.nan, dtype=int),
                                      'acknowledged': np.full(1, np.nan, dtype=int),
                                      'ticketnum': np.full(1, "", dtype=str), 'enterprise': np.full(1, "", dtype=str),
                                      'record_ts': np.full(1, np.nan, dtype=long),
                                      'incident': np.full(1, "", dtype=str),
                                      'incidents_id': np.full(1, np.nan, dtype=long)})
    incidentsserial_df = pd.DataFrame(index=[''], data={'serial': np.full(1, np.nan, dtype=long),
                                                        'rownullcount_serial': np.full(1, np.nan, dtype=int),
                                                        'rowzerocount_serial': np.full(1, np.nan, dtype=int)})
    es = EntitySet(id="entityset")
    es = es.entity_from_dataframe(entity_id="incidents", dataframe=incidents_df, index="incidents_id",
                                  variable_types={"alertgroup": variable_types.Categorical,
                                                  "agent": variable_types.Categorical,
                                                  "acknowledged": variable_types.Categorical,
                                                  "iturgency": variable_types.Categorical,
                                                  "alertkey": variable_types.Categorical,
                                                  "poll": variable_types.Categorical,
                                                  "type": variable_types.Categorical,
                                                  "suppressescl": variable_types.Categorical,
                                                  "serviceregion": variable_types.Categorical,
                                                  "resolvestatus": variable_types.Categorical,
                                                  "division": variable_types.Categorical,
                                                  "nodealias": variable_types.Categorical,
                                                  "automation": variable_types.Categorical,
                                                  "datatype": variable_types.Categorical,
                                                  "custzip": variable_types.Categorical,
                                                  "postalcode": variable_types.Categorical,
                                                  "chtrtype": variable_types.Categorical,
                                                  "itseverity": variable_types.Categorical,
                                                  "custstate": variable_types.Categorical,
                                                  "servicekma": variable_types.Categorical,
                                                  "itoperatingsystem": variable_types.Categorical,
                                                  "originalseverity": variable_types.Categorical,
                                                  "class": variable_types.Categorical,
                                                  "resolved": variable_types.Categorical,
                                                  "severity": variable_types.Categorical,
                                                  "manager": variable_types.Categorical,
                                                  "custcity": variable_types.Categorical,
                                                  "causetype": variable_types.Categorical,
                                                  "remedyflag": variable_types.Categorical,
                                                  "s1severity": variable_types.Categorical,
                                                  "causetype2": variable_types.Categorical,
                                                  "node": variable_types.Categorical,
                                                  "operstatus": variable_types.Categorical,
                                                  "servicetac": variable_types.Categorical,
                                                  "itgroup": variable_types.Categorical,
                                                  "grade": variable_types.Categorical,
                                                  "impactflag": variable_types.Categorical,
                                                  "servername": variable_types.Categorical,
                                                  "ticketnum": variable_types.Categorical,
                                                  "location": variable_types.Categorical,
                                                  "ticketstatus": variable_types.Categorical,
                                                  "tally": variable_types.Categorical,
                                                  "incident": variable_types.Categorical,
                                                  "lob": variable_types.Categorical,
                                                  "status": variable_types.Categorical,
                                                  "chtrcategory": variable_types.Categorical,
                                                  "itvendor": variable_types.Categorical,
                                                  "flash": variable_types.Categorical,
                                                  "test1": variable_types.Text, "test2": variable_types.Text,
                                                  "appsupport": variable_types.Text,
                                                  "chtrapplication": variable_types.Text,
                                                  "shortdescript": variable_types.Text,
                                                  "cllicode": variable_types.Text,
                                                  "suppresssend": variable_types.Text,
                                                  "impactpolicy": variable_types.Text,
                                                  "summary": variable_types.Text,
                                                  "identifier": variable_types.Text,
                                                  "devicedescript": variable_types.Text,
                                                  "customertype": variable_types.Text,
                                                  "originalsummary": variable_types.Text,
                                                  "comments": variable_types.Text,
                                                  "custstreet": variable_types.Text, "url2": variable_types.Text,
                                                  "custstreetname": variable_types.Text,
                                                  "interface": variable_types.Text,
                                                  "alarmsource": variable_types.Text,
                                                  "elementname": variable_types.Text,
                                                  "remedynum": variable_types.Text,
                                                  "circuit": variable_types.Text,
                                                  "servicescope": variable_types.Text,
                                                  "nmosserial": variable_types.Text,
                                                  "itapplication": variable_types.Text,
                                                  "hfcfibernode": variable_types.Text,
                                                  "suppresssstart": variable_types.Text,
                                                  "eventid": variable_types.Text,
                                                  "s1mgddevice": variable_types.Text,
                                                  "processid": variable_types.Text,
                                                  "sys_period": variable_types.Text,
                                                  "commstring": variable_types.Text,
                                                  "bundle": variable_types.Text,
                                                  "enterprise": variable_types.Text})
    es = es.entity_from_dataframe(entity_id="incidentsserial", dataframe=incidentsserial_df, index="serial")
    rels = [Relationship(es["incidentsserial"]["serial"], es["incidents"]["serial"])]
